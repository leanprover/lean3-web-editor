...
LATEST_BROWSER_LEAN=$(curl -s -N https://$GITHUB_TOKEN@api.github.com/repos/leanprover-community/lean/releases | grep -m1 "browser_download_url.*browser.zip" | cut -d / -f 8 | cut -d v -f 2)
